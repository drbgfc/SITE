                    ...
                    <div class="panel-body">
                        <div id="CCDA11">
                            <div id="CCDA1wrapper">
                                ...
                                <ol>
                                    <li>Please select a 2014 ONC S&CC objective or "NonSpecificC-CDA" from the drop down
                                        list.
                                    </li>
                            ...
                            <div id="CCDAReferenceWrapper">
                                ...
                                <form id="CCDAR2_0ValidationForm" action="${urlAction2_0}" method="POST"
                                    ...
                                    <ol>
                                        ...
                                        <li>Select a C-CDA Document Type or 2015 ONC S&CC Objective from the list below.
